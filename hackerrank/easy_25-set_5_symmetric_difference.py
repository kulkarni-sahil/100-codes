...
students_subbed_to_just_either_paper = students_subbed_to_english_paper.symmetric_difference(students_subbed_to_french_paper)

print(len(students_subbed_to_just_either_paper))