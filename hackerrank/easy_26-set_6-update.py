...
len_of_set = int(input())
input_set = set(map(int, input().split(' ')))
no_of_operations = int(input())
for _ in range(no_of_operations):
    # print()
    operation_cmd, _ = input().split(' ')
    temp_set = set(map(int, input().split(' ')))
    # print(temp_set)
    if operation_cmd == 'intersection_update':
        input_set.intersection_update(temp_set)
    elif operation_cmd == 'update':
        input_set.update(temp_set)
    elif operation_cmd == 'symmetric_difference_update':
        input_set.symmetric_difference_update(temp_set)
    elif operation_cmd == 'difference_update':
        input_set.difference_update(temp_set)
